(() => {
  ...
  const exact = new Map(Object.entries({
    ...
    '방향성 조명과 PBR 채널 검사 모드이며 알베도 검사와 동시에 켜지지 않습니다.': 'Directional lighting and PBR channel inspection cannot be enabled together with albedo inspection.',
    '방위': 'Azimuth',
    '고도': 'Elevation',
    '알베도 검사': 'Albedo inspection',
    '원본 색상만 표시하며, 끄면 균일한 기본 표시로 돌아갑니다.': 'Show only the source color; turning this off returns to the uniform default view.',
    ...
    'PBR 텍스처 읽는 중': 'Loading PBR textures',
    '선택한 상세 표면 채널을 준비하고 있어요.': 'Preparing the selected detailed surface channels.',
    'PBR 상세 텍스처 로딩 중': 'Loading detailed PBR textures',
    'PBR 상세 텍스처 준비 완료': 'Detailed PBR textures ready',
    'PBR 상세 텍스처를 불러오지 못했어요': 'Could not load detailed PBR textures',
    '뷰어 준비됨': 'Viewer ready',
    '파트 목록': 'Part list',
    ...
    '뒤쪽 함선 불투명도': 'Reference ship opacity',
    ...
    '파트 패널 너비 조절': 'Resize part panel width',
    '검색과 분류 영역 높이 조절': 'Resize search and category area',
    '선택 파트 영역 높이 조절': 'Resize selected-part area',
    '드래그하여 파트 패널 너비 조절': 'Drag to resize the part panel',
    '드래그하여 검색과 분류 영역 높이 조절': 'Drag to resize search and categories',
    '드래그하여 선택 파트 영역 높이 조절': 'Drag to resize the selected-part area'
  }));

  const replacements = [
    [/함포, 선체, 코드 검색/g, 'Search guns, hull, or code'],
    [/Ctrl\+Z 취소 · Ctrl\+Y 복원 · G 이동 · B 배경 · Home 전체 보기 · Esc 선택 해제/g,
      'Ctrl+Z Undo · Ctrl+Y Redo · G Move · B Background · Home Frame all · Esc Clear selection'],
    ...
    [/PBR 리소스 ([\d,]+) \/ ([\d,]+) 불러오는 중/g, 'Loading PBR resources $1 / $2'],
