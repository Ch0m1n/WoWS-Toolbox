        ...
        <Border Grid.Column="0" Background="#0B1728"
            ...
            <Grid Margin="18,22">
                ...
                <StackPanel Grid.Row="2">
                    ...
                    <TextBlock x:Name="FooterVersion" Text="v5.0.62"
            ...
            <Grid Grid.Row="1" Margin="30,24,30,24">
                ...
                <ScrollViewer x:Name="SettingsPage" Visibility="Collapsed"
                    ...
                    <StackPanel>
                        ...
                        <Border Style="{StaticResource CardBorder}" Margin="0,14,0,0">
                            <StackPanel>
                                <TextBlock Text="WoWS Toolbox 5.0.62 · 비공식 커뮤니티 도구"
...
function Send-ModelToViewer {
    ...
    if ($mappingChanged) {
        ...
        $core.Navigate(
            'https://viewer.local/index.html?app=5.0.62&lang=' +
...
function Complete-ModelViewerInitialization {
    ...
    $core.Navigate("https://viewer.local/index.html?app=5.0.62&lang=$script:WoWSToolboxLanguage")
}
