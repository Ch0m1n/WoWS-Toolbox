...
foreach ($marker in @(
    ...
    'Test-DeprecatedPackagedOutputPath', '?app=5.0.64',
...
if ($launcherInfo.VersionInfo.FileVersion.Trim() -ne '5.0.64.0' -or
    $launcherInfo.VersionInfo.ProductVersion.Trim() -ne '5.0.64') {
...
if ($environmentSkips) {
    Write-Host "WoWS Toolbox 5.0.64 self-tests passed with $environmentSkips environmental skip(s)."
}
else {
    Write-Host 'WoWS Toolbox 5.0.64 self-tests passed.'
}
